...
module.exports = (systemData, user, allData = false) => ([
  ...
  test('vigoot-02', 'Har fornavn og etternavn', 'Sjekker at bruker er registrert med fornavn og etternavn', () => {
    ...
    if (!systemData.fornavn || !systemData.etternavn) return error({ message: 'Mangler fornavn og/eller etternavn', raw: systemData, solution: `Rettes i ${systemNames.vigoot}` })
  ...
  test('vigoot-03', 'Har tilknytning', 'Sjekker at bruker har tilknytning', () => {
    ...
    if (!data.tilknytningnr || !data.tilknytningnavn) return error({ message: 'Mangler tilknytning', raw: data, solution: `Rettes i ${systemNames.vigoot}` })
