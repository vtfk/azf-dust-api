...
module.exports = (systemData, user, allData = false) => ([
  test('feide-01', 'Har data', 'Sjekker at det finnes data her', () => {
    ...
    if (!dataPresent) {
      ...
      else return success({ message: 'Det er ikke forventet FEIDE-konto på denne brukeren', solution: 'Dersom det er behov for FEIDE-konto, meld sak til arbeidsgruppe identitet' })
